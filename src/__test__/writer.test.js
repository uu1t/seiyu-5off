...
describe('.write()', () => {
  ...
  it('writes dates', () => {
    ...
    expect(written).toEqual(['2006-01-02T00:00:00+09:00', '2006-01-03T00:00:00+09:00'])
  })
  ...
  "2006-01-03T00:00:00+09:00"
    ...
    const written = JSON.parse(fs.readFileSync(filepath(2006)))
    expect(written).toEqual(['2006-01-02T00:00:00+09:00', '2006-01-03T00:00:00+09:00', '2006-01-04T00:00:00+09:00'])
  })
})
